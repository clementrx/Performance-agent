...
2. If a protocol already exists for this event (`read_competition_protocol`),
   read it first: the v2+ reason names what changed since v{N}, and unchanged
...
6. Walk the draft through with the athlete, then submit it to program-review's
